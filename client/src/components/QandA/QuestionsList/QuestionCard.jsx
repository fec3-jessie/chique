  ...
  render() {
    return (
      ...
      <>
        ...
        <Answers answers={this.props.answers} key={this.props.ID * 3} answerCounter={this.state.answerCounter} showMore={this.state.showMoreBtn} collapse={this.state.showCollapseBtn}/>
        {
